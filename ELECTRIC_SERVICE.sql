...
CREATE DATABASE ELECTRIC_SERVICE;
...
--*************************************************************************************************************--
INSERT INTO PROVEEDORES VALUES('E-01','ICE',25896314,'ESCAZÚ, SAN JOSÉ',1000030000200008)
INSERT INTO PROVEEDORES VALUES('E-02','CNFL',23147596,'CURRIDABAT, SAN JOSÉ',1230030000200008)
INSERT INTO PROVEEDORES VALUES('E-03','JASEC',23214659,'TIERRA BLANCA, CARTAGO',1000030000200048)

SELECT * FROM PROVEEDORES

INSERT INTO CLIENTES VALUES('305250862','KEVIN ANDRÉS','NAVARRO TENCIO',70151868,'TABLÓN CARTAGO','knavatencio2@gmail.com')

INSERT INTO SERVICIO VALUES(4514182,'305250862','E-01',GETDATE())

INSERT INTO FACTURAS (num_servicio,fecha_vencimiento,monto,estado) 
VALUES(4514182,'2020-12-15',15000,'OUTSTANDING')
INSERT INTO FACTURAS (num_servicio,fecha_vencimiento,monto,estado) 
VALUES(4514182,'2020-11-15',15000,'PAID')

UPDATE FACTURAS SET estado='OUTSTANDING' WHERE fecha_vencimiento='2020-12-15' and num_servicio=4514182
