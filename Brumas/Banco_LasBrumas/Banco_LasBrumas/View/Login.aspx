<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Proyecto_Banco.Login" %>
			...
			<form id="form1" runat="server">
				...
				<h2 class="title">Welcome</h2>
           		...
           		<div class="input-div pass">
           		   ...
           		   <div class="div">
           		    	<%--<h5>Password</h5>--%>
           		    	<asp:TextBox ID="txt_contraseña" runat="server" CssClass="input"  placeholder="Password"></asp:TextBox>
            	   </div>
            	</div>
