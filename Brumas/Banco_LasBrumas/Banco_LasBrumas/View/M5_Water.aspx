<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Banco_LasBrumas.Controller.ControllerServices.cs" Inherits="Banco_LasBrumas.Controller.ControllerServices" %>
            ...
            if (myVar1 === "") {
                ...
                var table = $("#tablita").DataTable({
                    ...
                    ajax: {
                        ...
                        dataType: "json",
                        failure: function (result) { alert("rr"); },
                        dataSrc:   function(d) {
                            if (d.result = "OK") {
...
<body>
	...
	<main style="margin-top: 11.8%">
		<div class="espacio">
			<div style="width: 100%;height: 100px; background-color: #232323; text-align: center; padding: 1% 5% 5% 5%;"><h1 class="titulo" style="color: white">Water payment</h1></div>
            ...
            <div style="  padding: 5% 15% 0% 15%;">
                  ...
                  <asp:ListItem Value="Acueducto Asuacom"> Acueducto Asuacom </asp:ListItem>
                  <asp:ListItem Value="ESPH"> ESPH </asp:ListItem>
					...
					<div class="form-group">
						<label for="email">NIS:</label>
                         <asp:TextBox ID="txtIdentificacion" runat="server"  class="form-control" placeholder="Enter the NIS" ></asp:TextBox>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Water payment</h4>
        </div>
