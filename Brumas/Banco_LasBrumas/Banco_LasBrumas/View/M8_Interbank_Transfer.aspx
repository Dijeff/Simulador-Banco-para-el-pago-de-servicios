<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M8_Interbank_Transfer.aspx.cs" Inherits="Banco_LasBrumas.View.M8_Interbank_Transfer" %>
				...
				<div class="col-md-12">
					<div class="well well-sm">
						<form id="form1" runat="server" class ="form-horizontal" >
							<fieldset>
								<legend class="text-center header">Interbank Transfer</legend>
								...
								<div class="form-group">
									<span class="col-md-1 col-md-offset-2 text-center"></span>
										<div class="col-md-8">
											...
											<asp:Label ID="indicador" runat="server" Text="Choose an account" ForeColor="black" ></asp:Label>
											</br>
										</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										 ...
										 <asp:DropDownList ID="cuenta_origen" AutoPostBack="True"  class="form-control" runat="server">
								...
								<div class="form-group">
									<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-envelope-o bigicon"></i></span>
									<div class="col-md-8">
										<asp:textbox id="cuenta_destino" name="cuenta_destino" placeholder="Destiny account" runat="server" CssClass="form-control" required MaxLength="100"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<asp:textbox id="detalle" name="detalle"  placeholder="Detail" runat="server" CssClass="form-control" required MaxLength="100"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<asp:TextBox  id="monto"  name="monto" placeholder="Amount" runat="server" CssClass="form-control" required MaxLength="100"/>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-md-12 text-center">
										<asp:Button ID="Transfer_btn" class="btn btn-primary btn-lg" runat="server" OnClick="Transfer_btn_Click"  Text="Make Transfer" />
										</br>
										</br>
