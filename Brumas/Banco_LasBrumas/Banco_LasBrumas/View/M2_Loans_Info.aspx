<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Banco_LasBrumas.Controller.controlador_loans_info.cs" Inherits="Banco_LasBrumas.Controller.controlador_loans_info" %>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
          ...
          <table class="table">
				...
				<tbody>
					<tr>
                        ...
                        <Columns>
                            <asp:BoundField  DataField="cod_prestamo" />
                            <asp:BoundField  DataField="nombre" />
							<asp:BoundField  DataField="apellidos" />
                            <asp:BoundField  DataField="saldo_deber" />
							 <asp:BoundField  DataField="saldo_abonado" />
