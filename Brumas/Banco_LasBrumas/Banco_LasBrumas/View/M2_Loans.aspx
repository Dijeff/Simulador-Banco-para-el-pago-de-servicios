<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Banco_LasBrumas.Controller.Controller_Loans.cs" Inherits="Banco_LasBrumas.Controller.Controller_Loans" %>
				...
				<div class="col-md-12">
					<div class="well well-sm">
						<form runat="server" class="form-horizontal">
							<fieldset>
								<legend class="text-center header">Loans</legend>
