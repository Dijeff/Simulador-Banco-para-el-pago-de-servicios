<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Banco_LasBrumas.Controller.Controller_Edit_Profile.cs" Inherits="Banco_LasBrumas.Controller.Controller_Edit_Profile" %>
						...
						<form id="form1" runat="server" class ="form-horizontal" >
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<asp:textbox id="email" name="email" placeholder="Email Address" runat="server" CssClass="form-control" required MaxLength="100"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<asp:textbox id="phone" name="phone"  placeholder="Phone" runat="server" CssClass="form-control" required MaxLength="30"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<asp:TextBox  id="direction"  name="direction" TextMode="multiline" placeholder="Client Address" Rows="7" runat="server" CssClass="form-control" required MaxLength="200"/>
									</div>
								</div>

								<div class="form-group">
									<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-exclamation-triangle"></i></span>
									<div class="col-md-8">
										<asp:textbox  id="pass" name="pass"  placeholder="Password" runat="server" CssClass="form-control" required MaxLength="8"/>
									</div>
								</div>
		
								<div class="form-group">
									<div class="col-md-12 text-center">
										<asp:Button ID="Save_btn" class="btn btn-primary btn-lg" runat="server" OnClick="Save_btn_Click"  Text="Save" />
									</div>
								</div>
							</fieldset>
						</form>
