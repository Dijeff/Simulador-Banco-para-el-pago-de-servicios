<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Banco_LasBrumas.Controller.ControllerInternet.cs" Inherits="Banco_LasBrumas.Controller.ControllerInternet" %>
        ...
        function dtUsers2() {
            ...
            if (myVar1 === "") {
                ...
                var table = $("#tablita").DataTable({
                    ...
                    ajax: {
                        method: "POST",
                        url: "M5_Internet.aspx/getUsers2",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: function (d) {
...
<body>
	...
	<main style="margin-top: 11.8%">
		<div class="espacio">
			<div style="width: 100%;height: 100px; background-color: #232323; text-align: center; padding: 1% 5% 5% 5%;"><h1 class="titulo" style="color: white">Internet payment</h1></div>
					...
					<div class="form-group">
						<label for="email">Company:</label>
						 <asp:DropDownList ID="jeje"
							  ...
							  <asp:ListItem Value="JASEC"> JASEC </asp:ListItem>
							  <asp:ListItem Value="TIGO"> TIGO </asp:ListItem>
							 <asp:ListItem Value="CLARO"> CLARO </asp:ListItem>
							  <asp:ListItem Value="CABLETICA"> CABLETICA </asp:ListItem>
						</asp:DropDownList>
					</div>
					<div class="form-group">
						<label for="email">Find service number:</label>
				 <asp:TextBox ID="txtIdentificacion" runat="server"  class="form-control" placeholder="Enter the service number" ></asp:TextBox>
					</div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Internet payment</h4>
        </div>
