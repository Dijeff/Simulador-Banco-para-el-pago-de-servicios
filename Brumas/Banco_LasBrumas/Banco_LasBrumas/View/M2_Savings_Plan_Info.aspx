<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Banco_LasBrumas.Controller.controladorplan.cs" Inherits="Banco_LasBrumas.Controller.controladorplan" %>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
         ...
         <table class="table">
				...
				<tbody>
					<tr>
                        ...
                        <Columns>
                            <asp:BoundField  DataField="id_plan" />
                            <asp:BoundField  DataField="nombre" />
							<asp:BoundField  DataField="apellidos" />
                            <asp:BoundField  DataField="saldo_ahorrado" />
                        </Columns>
