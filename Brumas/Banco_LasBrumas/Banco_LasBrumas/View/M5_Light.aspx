...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Banco_LasBrumas.Controller.ControllerLight.cs" Inherits="Banco_LasBrumas.Controller.ControllerLight" %>
...
<body>
	...
	<main style="margin-top: 11.8%">
		<div class="espacio">
			<div style="width: 100%;height: 100px; background-color: #232323; text-align: center; padding: 1% 5% 5% 5%;"><h1 class="titulo" style="color: white">Light Payment</h1></div>
			<div style="  padding: 5% 15% 0% 15%;">
                  ...
                  <asp:TextBox ID="txtIdentificacion" runat="server"  class="form-control" placeholder="Enter the number" ></asp:TextBox>
					</div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Light Payment</h4>
        </div>
