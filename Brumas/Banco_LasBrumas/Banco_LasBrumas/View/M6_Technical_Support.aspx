<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Banco_LasBrumas.Controller.Controller_Technical_Support.cs" Inherits="Banco_LasBrumas.Controller.Controller_Technical_Support" %>
				...
				<div class="col-md-12">
					<div class="well well-sm">
						<form id="form1" runat="server" class="form-horizontal" >
							<fieldset>
								<legend class="text-center header">Technical Support</legend>
								...
								<div class="form-group">
									<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-envelope-open bigicon"></i></span>
									<div class="col-md-8">
										<asp:textbox id="Subject" name="Subject"  placeholder="Subject" runat="server" CssClass="form-control"/>
									</div>
								</div>
		
								<div class="form-group">
									<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-comments bigicon"></i></span>
									<div class="col-md-8">
										<asp:TextBox  id="Message"  name="Message" TextMode="multiline" placeholder="Message" Rows="7" runat="server" CssClass="form-control"/>
									</div>
								</div>
		
								<div class="form-group">
									<div class="col-md-12 text-center">
										<asp:Button ID="Sent_btn" class="btn btn-primary btn-lg" runat="server"  OnClick="Ingresar_btn_Click"  Text="Send"  OnClientClick = "alert('Su duda ha sido enviada a nuestros agentes');"/>   	
									</div>
								</div>
