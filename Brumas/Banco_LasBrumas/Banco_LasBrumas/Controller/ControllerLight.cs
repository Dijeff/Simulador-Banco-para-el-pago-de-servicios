...
{
    public partial class ControllerLight : System.Web.UI.Page
    {
        ...
        protected void btnrealizar(object sender, EventArgs e)
        {
            ...
            if ((string.IsNullOrEmpty(ddlLista.Text))) throw new Exception("Ingrese el usuario y la contraseña");
            {
                ...
                string detail = "ELECTRICAL SERVICE PAYMENT";
                ...
                if(proceso.Equals("In process"))
                {
                    ...
                    string result = obclsSedes.pagowebservicesluz(ddlLista.Text, jeje.Text, Convert.ToInt32(dato));
                    
                    proceso = accounts_info.resultado_transaccion(ddlLista.Text, monto, jeje.Text, detail, tipo_proceso, result);
        ...
        public static object getUsers2(string nis, string provedor)
        {
            ...
            List<string> dsConsulta = obclsClientes.webservicesluz(Convert.ToInt32(nis), provedor);
