...
{
    public partial class Controller_Credit_Cards : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable sedes = obclsSedes.View_Credit_Cards(id);
        ...
        protected void Consult_btn_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("M2_Credit_Card_Info.aspx");
        }
