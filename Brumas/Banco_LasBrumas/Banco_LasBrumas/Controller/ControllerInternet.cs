...
{
    public partial class ControllerInternet : System.Web.UI.Page
    {
        ...
        protected void btnrealizar(object sender, EventArgs e)
        {
            ...
            if ((string.IsNullOrEmpty(ddlLista.Text))) throw new Exception("Ingrese el usuario y la contraseña");
            {
                ...
                string detail = "INTERNET SERVICE PAYMENT";
                ...
                if (proceso.Equals("In process"))
                {
                    ...
                    string result = obclsSedes.pagowebservicesInternet(ddlLista.Text, jeje.Text, Convert.ToInt32(dato));
        ...
        public static object getUsers2(string nis, string provedor)
        {
            ...
            List<string> dsConsulta = obclsClientes.WebServiceInternet(Convert.ToInt32(nis), provedor);
