...
{
    public partial class ControllerServices : System.Web.UI.Page
    {
        ...
        protected void btnrealizar(object sender, EventArgs e)
        {
            ...
            if ((string.IsNullOrEmpty(ddlLista.Text))) throw new Exception("Ingrese el usuario y la contraseña");
            {
                ...
                string detail = "WATER SERVICE PAYMENT";
                ...
                if (proceso.Equals("In process"))
                {
                    ...
                    string result = obclsSedes.pagowebservicesagua(ddlLista.Text, jeje.Text, Convert.ToInt32(dato));
        ...
        public static object getUsers2(string nis, string provedor)
        {
            ...
            List<string> dsConsulta = obclsClientes.webservicesagua(Convert.ToInt32(nis), provedor);
